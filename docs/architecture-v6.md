...
| V6.29 | Natural-Language Automation | Automation Engine arbeitet vollständig auf semantischer Ebene (Trigger + Action + Property + Value aus natürlicher Sprache) | **teilweise live**: Actions und relative Delayed Commands nutzen gemeinsame Semantik; State-Trigger und State-Conditions teilen `nlu/semantic_automation.py` und erlauben freie Reihenfolge. Zeit, Sonne, numerische Schwellen und Geräteereignisse bleiben bewusst in spezialisierten Parsern |
