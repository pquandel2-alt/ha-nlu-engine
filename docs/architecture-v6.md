...
Abschnitt 8). Stand: Semantic Compiler 2.0 / HomeIntent 4.28.0
...
| V6.20 | Natural Query Language | Verschiedene Frageformen ("sind offen?"/"noch offen?"/"gibt es offene...?") auf dieselbe Semantik abbilden | **live und in Migration**: Der semantische Compiler kombiniert Geräteklasse, Zustand, Ort/Etage und Query-Operation unabhängig von ihrer Reihenfolge. Unterstützt State, Exists, Count, List, All/None und Locations. Messwertfragen kombinieren zusätzlich Property, Ort, Comparator und Schwellenwert frei; spezialisierte Einzelentitäts- und komplexe Vergleichsparser bleiben im Hassil-Kompatibilitätspfad |
